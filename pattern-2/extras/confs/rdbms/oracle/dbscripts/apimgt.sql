...
create tablespace wso2api26 datafile 'wso2api.tdf' size 100M autoextend on;

create user wso2api default tablespace wso2api26 identified by wso2api;

GRANT connect, create procedure, create session, create table, create type, create view, create synonym,create sequence, create trigger, resource TO wso2api;
GRANT CONNECT, RESOURCE, DBA TO wso2api;

connect wso2api/wso2api;
