...
create tablespace wso2carbon26 datafile 'wso2carbon.tdf' size 100M autoextend on;

create user wso2carbon default tablespace wso2carbon26 identified by wso2carbon;
GRANT connect, create procedure, create session, create table, create type, create view, create synonym,create sequence, create trigger, resource TO wso2carbon;
GRANT CONNECT, RESOURCE, DBA TO wso2carbon;

connect wso2carbon/wso2carbon;


-- wso2 carbon userstore initialization 
