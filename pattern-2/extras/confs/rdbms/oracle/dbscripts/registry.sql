...
create tablespace wso2reg26 datafile 'wso2reg.tdf' size 100M autoextend on;

create user wso2reg default tablespace wso2reg26 identified by wso2reg;

GRANT connect, create procedure, create session, create table, create type, create view, create synonym,create sequence, create trigger, resource TO wso2reg;
GRANT CONNECT, RESOURCE, DBA TO wso2reg;

connect wso2reg/wso2reg;
